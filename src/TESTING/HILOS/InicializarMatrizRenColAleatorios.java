...
//	int [][] m;
//	Random r=new Random();
//	static master.model.Semaforo[][] s;
//	static boolean [][] band=null;
//	static master.model.Semaforo sinc;
//	static int cont=0;
//	public HiloRenColAleatorio(int [][] m) {
//		this.m=m;
//		sinc=new master.model.Semaforo(1);
//		if(band==null) {
//			band=new boolean[m.length][m[0].length];;
//			s=new master.model.Semaforo[m.length][m[0].length];
//			for(int i=0 ; i<s.length ; i++)
//				for(int j=0 ; j<s[i].length ; j++) {
//					s[i][j]=new master.model.Semaforo(1);
//					band[i][j]=false;
//				}
//		}
//	}
