...
public class StationInside extends StationController implements Runnable{
    public StationInside(int pos, int line) {
        super(pos, line);
    }
    ...
    public void run() {
        while(true){
            ...
            System.out.println("ENTRE A TRABAJAR INTERIORES");
            try {
